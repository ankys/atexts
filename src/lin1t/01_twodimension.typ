...
#definition([$2$次の逆行列])[
$2$次正方行列$A = mat(a, b; c, d)$が$a d-b c != 0$を満たすとき定義される次の行列
$
...
$
cases(
	x_(n+1) = a x_n+b y_n"," &quad x_0 = e",",
	y_(n+1) = c x_n+d y_n"," &quad y_0 = f
)
$
を満たす状況を考える。
...
$
cases(
	x_(n+1) = 0.6 x_n+0.4 y_n"," &quad x_0 = 1",",
	y_(n+1) = 0.4 x_n+0.6 y_n"," &quad y_0 = 2
)
$
が成り立つ。
